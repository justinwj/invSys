...
Add-Check "Build.RoleConnectServerButtons" ($buildText.Contains('btnOperationsConnectServer') -and -not $buildText.Contains('btnReceivingConnectServer') -and -not $buildText.Contains('btnShippingConnectServer') -and -not $buildText.Contains('btnProductionConnectServer')) "The D12 Operations ribbon exposes one Connect Server button and no retired standalone role buttons."
Add-Check "Build.RoleSignOutButtons" ($buildText.Contains('btnOperationsSignOut') -and -not $buildText.Contains('btnReceivingSignOut') -and -not $buildText.Contains('btnShippingSignOut') -and -not $buildText.Contains('btnProductionSignOut')) "The D12 Operations ribbon exposes one Sign Out button and no retired standalone role buttons."
