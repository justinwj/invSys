...
| Production.Form.FiveTargetPages | FAIL | The public Production form exposes Process Designer, Recipe Designer, Ingredients Assignment, Run List, and experimental Run Tree, with no Recipe Builder page. |
...
| Production.ProcessDesigner.RequiresOutput | FAIL | The form and Designs Domain both reject a Process definition with no output. |
...
| DesignsDomain.ProcessRecipeSchemaAndEvents | FAIL | The headless Designs Domain owns reusable Process/Recipe lifecycle events and rebuildable projections. |
| Viewer.ProductionOperatorEvents | FAIL | Published Viewer Events expose correlated Production input consumption and output creation as operator actions. |
