...
Private Function AssertRepeatedAdminSeedCreatesUniqueKeysCreateWarehouse( _
    ...
    If firstKeys.Count <> beforeKeys.Count + 24 Then
        detail = "First Admin seed expected 24 newly keyed entities; before=" & _
    ...
    If secondKeys.Count <> firstKeys.Count + 24 Then
        detail = "Second Admin seed expected 24 newly keyed entities; first=" & _
    ...
    detail = "Repeated Admin seed created 48 new collision-free System_Key values with Condition=GOOD and no migration event."
